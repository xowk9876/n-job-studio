...
export default function Header() {
  ...
  return (
    <header className="site-header sticky top-0 z-40 backdrop-blur-xl border-b border-[color:var(--line)]">
      <div className="site-header__brand max-w-5xl mx-auto px-4 md:px-6 h-11 md:h-12 flex items-center justify-center">
        <Link href="/" className="inline-reset flex items-center gap-2">
          ...
          <span className="font-semibold text-[14px] md:text-[14.5px] tracking-tight text-[color:var(--ink)]">머니핏 계산기</span>
        </Link>
      </div>
