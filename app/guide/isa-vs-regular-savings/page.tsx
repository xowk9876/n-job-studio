  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>매년 2,000만 원씩 10년간 납입, 복리 연 4% 수익 가정:</p>
        <ul>
          <li>총 납입 원금: 2억 원</li>
          <li>10년 뒤 평가액: 약 2억 4,973만 원</li>
          <li>총 수익: 약 4,973만 원</li>
        </ul>
        <h3>일반계좌(이자소득세 15.4%)</h3>
        <ul>
          <li>세금: 4,973만 원 × 15.4% = <strong>약 765만 원</strong></li>
          <li>세후 수익: 약 4,208만 원</li>
        </ul>
        <h3>ISA(비과세 200만 원 + 9.9% 분리과세)</h3>
        <ul>
          <li>비과세 구간: 200만 원</li>
          <li>과세 구간: 4,773만 원 × 9.9% = <strong>약 472만 원</strong></li>
          <li>세후 수익: 약 4,501만 원</li>
        </ul>
        <p>
          단순 계산만으로 <strong>약 293만 원</strong>이 남습니다. 금융소득 종합과세 대상(연 2,000만 원
          초과)이거나 고소득자라면 절세 폭이 더 커집니다.
        </p>
      </section>
