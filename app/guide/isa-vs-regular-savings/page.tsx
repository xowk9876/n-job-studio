...
const description =
  'ISA 비과세 한도(일반형 200만 원·서민형 400만 원)와 9.9% 분리과세의 실제 절세 효과를 10년 시뮬레이션으로 비교. 중개형·신탁형·일임형 선택 기준과 만기 이전 인출 시 주의사항까지.'
    ...
    >
      <section>
        ...
        <p>
          ...
          국내주식(중개형)을 운용할 수 있고, 3년 이상 의무 가입 후 <strong>순이익 200만 원(서민형·농어민형 400만 원)까지
          비과세</strong>, 초과분은 <strong>9.9%</strong>로 분리과세되는 절세 상품입니다. 일반 계좌의 이자소득세
          15.4%보다 훨씬 유리합니다(조세특례제한법 제91조의18). 비과세 한도를 500만/1,000만 원으로 늘리는
          개정안이 발의된 적 있으나 국회에서 부결되어 시행되지 않았습니다(2026년 7월 기준).
        </p>
      </section>
      ...
      <section>
        ...
        <p>연간 납입 한도 2,000만 원, 총 1억 원까지 납입 가능합니다(미사용 한도는 이월).</p>
      </section>
      ...
      <section>
        ...
        <p>
          매년 말 1,000만 원씩 10년간 납입(총 납입 한도 1억 원 이내), 복리 연 4%로 재투자한다고 가정하면:
        </p>
        <ul>
          <li>총 납입 원금: 1억 원</li>
          <li>10년 뒤 평가액: 약 1억 2,006만 원</li>
          <li>총 수익: 약 <strong>2,006만 원</strong></li>
        </ul>
        <h3>일반계좌(이자·배당소득세 15.4%)</h3>
        <ul>
          <li>세금: 2,006만 원 × 15.4% ≈ <strong>약 309만 원</strong></li>
          <li>세후 수익: 약 1,697만 원</li>
        </ul>
        <h3>ISA 일반형(비과세 200만 원 + 초과분 9.9% 분리과세)</h3>
        <ul>
          <li>비과세 구간: 200만 원</li>
          <li>과세 구간: 1,806만 원 × 9.9% ≈ <strong>약 179만 원</strong></li>
          <li>세후 수익: 약 1,827만 원</li>
        </ul>
        <p>
          이 단순 비교만으로 <strong>약 130만 원</strong>이 남습니다. 서민형(총급여 5,000만 원 이하 등)
          가입자는 비과세 한도가 400만 원으로 늘어 절세폭이 더 커집니다. 금융소득 종합과세(연 2,000만 원
          초과) 대상이거나 고소득 구간일수록 ISA의 분리과세 가치가 커집니다. ISA는 3년 의무가입 후
          만기 연장·재가입이 가능해 장기 운용에도 적합합니다.
        </p>
      </section>
      ...
      <section>
        <h2>어떤 사람에게 유리한가</h2>
        <ul>
          <li><strong>예·적금 중심의 안정 추구형:</strong> 이자소득 200만 원까지 세금 0원 — 일반계좌 대비 약 31만 원 절세</li>
