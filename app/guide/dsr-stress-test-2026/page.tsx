    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          설정됩니다. 2025년 7월 1일부터 3단계가 시행되어 가계대출에 기본 <strong>1.50%p</strong>가 적용되며,
          수도권·규제지역 주담대는 2025년 10.15 대책 이후 스트레스금리 <strong>3.0%p</strong>가 100% 반영됩니다.
          지방 비규제지역 주담대는 금융위 행정지도로 3단계 적용이 <strong>2026년 12월 31일까지 유예</strong>되어
          2단계 수준인 0.75%p(스트레스금리 1.5% × 적용비율 50%)가 계속 적용됩니다. 신용대출은 잔액 1억 원
          초과분에 한해 스트레스 금리가 부과됩니다.
        </p>
      </section>
