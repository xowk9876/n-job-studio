  ...
  return (
    <div className="calc-page">
      ...
      <FAQSection items={[
        ...
        { q: '1등 당첨 확률이 정말 1/8,145,060인가요?', a: '맞습니다. 45개 숫자 중 6개를 뽑는 조합의 수 C(45,6) = 8,145,060. 한 게임(1,000원)당 1등 확률은 0.0000123%. 비교하면 벼락 맞을 확률(약 1/100만)보다 낮고, 비행기 추락 사망률(1/1,100만)과 유사한 수준입니다.' },
        { q: '자동 vs 수동, 당첨 확률 차이 있나요?', a: '통계적으로 차이 없습니다. 모든 조합은 수학적으로 동일한 확률(1/8,145,060)을 가집니다. 다만 수동 선택 시 생년월일·특정 패턴으로 뽑는 사람이 많아, 만약 그런 번호가 당첨되면 당첨자 수가 많아 1등 분배금이 줄어드는 경향(확률의 독립성과 분배금은 별개).' },
