...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'ko_KR',
    type: 'website',
    images: [{ url: 'https://n-job-studio.vercel.app/savings/opengraph-image', width: 1200, height: 630, alt: '적금·예금 이자 계산기' }],
  },
  twitter: { card: 'summary_large_image', title: '적금·예금 이자 계산기', description: '단리·복리, 이자소득세 15.4% 차감 후 세후 만기 수령액 계산', images: ['https://n-job-studio.vercel.app/savings/opengraph-image'] },
