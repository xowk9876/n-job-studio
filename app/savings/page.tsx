    ...
    <div className="calc-page">
      ...
      <div className="mt-2 flex flex-col gap-8">
        ...
        <FAQSection items={[
          ...
          { q: 'ISA 계좌 비과세 한도는?', a: '2024년 한도 확대 후 일반형 연 200만원까지 이자·배당 비과세(초과분 9.9% 분리과세), 서민형(총급여 5,000만원 이하·종합소득 3,800만원 이하)·농어민형은 연 400만원까지 비과세. 납입한도는 연 2,000만원·총 1억원. 의무가입 3년. 근거: 조세특례제한법 제91조의18.' },
          { q: '파킹통장 vs 정기예금, 언제 무엇을?', a: '파킹통장은 수시입출금 + 일복리 이자(2024~2025년 기준 카뱅 2.0~2.5%, 케뱅 2.3%, 토뱅 2.0~2.3% 수준). 3~6개월 내 사용 예정 자금은 파킹통장, 1년 이상 묶어둘 수 있으면 정기예금(시중은행 연 3.5~4.0%)이 유리. 비상금은 생활비 3~6개월치를 파킹통장에 보관 추천.' },
          { q: '청년도약계좌·청년희망적금 남아있나요?', a: '청년희망적금(2022~2024 만기분)은 종료. 청년도약계좌(2023.6 출시)는 만 19~34세, 개인소득 7,500만원 이하·가구소득 중위 180% 이하 대상, 월 최대 70만원 5년 납입 시 정부기여금(최대 월 2.4만원) + 비과세 적용으로 최대 약 5,000만원 수령 가능. 근거: 조세특례제한법 제91조의22.' },
          { q: '저축은행 예금은 안전한가요?', a: '예금자보호법에 따라 원금+이자 합산 1인당 금융기관별 5,000만원까지 예금보험공사가 보장합니다(2024년 법 개정으로 2025년 중 1억원 상향 예정). 저축은행 금리는 시중은행 대비 0.5~1.0%p 높은 편이지만 1개 저축은행당 5,000만원 이내로 분산 예치하세요.' },
        ]} />
        <TipsSection title="이자 극대화 전략" items={[
          { title: 'ISA 계좌 먼저 채우기', desc: '연 2,000만원 한도 내에서 예적금·ETF·리츠 편입 가능. 연 200~400만원까지 비과세로 일반 계좌 대비 15.4% 세금 차이가 복리로 누적되면 10년 기준 수백만원 차이. 총급여 5,000만원 이하라면 서민형(400만원)으로 개설.' },
          { title: '인터넷은행·저축은행 우대 활용', desc: '카카오뱅크·케이뱅크·토스뱅크는 첫 거래·급여이체·체크카드 사용 조건으로 0.3~1.0%p 우대. 저축은행중앙회 SB톡톡플러스에서 전국 저축은행 금리 실시간 비교 가능. 개별 저축은행 5,000만원 이내 분산.' },
          { title: '풍차돌리기 적금', desc: '매월 1년 만기 적금을 새로 가입해 12개 적금을 운용하면 1년차부터 매월 만기금 수령 가능. 유동성과 복리 효과를 동시에 확보. 인뱅 + 시중은행 조합으로 금리별 분산.' },
          { title: '청년도약계좌 자격되면 필수', desc: '만 19~34세 + 개인소득 7,500만원 이하이면 월 70만원 5년 납입 시 정부기여금(최대 월 2.4만원·약 150만원)과 비과세 결합으로 실질 연 7~9% 수익률. 병역이행기간 최대 6년 나이 연장.' },
