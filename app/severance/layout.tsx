...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'ko_KR',
    type: 'website',
    images: [{ url: `${SITE}/severance/opengraph-image`, width: 1200, height: 630, alt: '퇴직금 계산기' }],
  },
  twitter: { card: 'summary_large_image', title: '퇴직금 계산기', description: '근로기준법 기준 1일 평균임금 자동 산출 퇴직금 계산', images: [`${SITE}/severance/opengraph-image`] },
