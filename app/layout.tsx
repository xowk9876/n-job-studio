...
export const metadata: Metadata = {
  ...
  description:
    '2026년 최신 세율·법령 기준. 연봉 실수령액, 대출 이자, 퇴직금, 적금 복리, 전월세 전환, 로또, 부업 세금 리스크, AI 마케팅 글 생성까지. 광고 팝업 없이 결과부터 보여주는 한국 재테크 계산기 — 머니핏 계산기.',
  keywords: [
    '머니핏', '머니핏 계산기',
...
function StructuredData() {
  const calcs = [
    ...
    { name: '부업 세금 리스크 예측기', path: '/tax-risk', desc: 'N잡러 세금·건보료 위험도 실시간 예측' },
    { name: 'AI 마케팅 글 생성기', path: '/ai',         desc: 'Gemini AI 제휴 마케팅 블로그 자동 생성' },
  ]
  const ld = {
