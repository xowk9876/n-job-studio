    ...
    <div className="calc-page">
      ...
      <div className="mt-2 flex flex-col gap-8">
        ...
        <FAQSection items={[
          ...
          { q: '전세 vs 월세 무엇이 유리한가요?', a: '본인의 기회비용(보증금 조달 비용 또는 운용수익률)과 실제 전환율을 비교하세요. 전세자금대출 금리(2026년 기준 연 4.0~4.8%)가 월세 전환율(4.5%)보다 낮으면 전세가 유리. 목돈을 예적금·투자로 운용할 수 있다면 그 수익률과 비교. 장기 거주 계획이면 전세, 2년 이내 이사 가능성 있으면 월세가 유연합니다.' },
        ...
        <TipsSection title="전세 · 월세 안전 체크리스트" items={[
          ...
          { title: '전세자금대출 활용', desc: '청년(만 19~34세)은 중소기업청년전세대출(연 1.2~2.1%, 최대 1억원, 보증금 2억 이하), 버팀목전세자금(연 2.1~2.9%, 최대 1.2억, 연소득 5,000만 이하) 등 정책자금 우선. 시중은행 HF(주택금융공사) 보증 전세대출 연 4.0~4.8%.' },
