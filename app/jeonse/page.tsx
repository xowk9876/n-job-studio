    ...
    <div className="calc-page">
      ...
      <div className="mt-2 flex flex-col gap-8">
        ...
        <FAQSection pagePath={CALC_PATH} items={[
          { q: '전월세 전환율이란 정확히 무엇인가요?', a: '전세보증금의 일부 또는 전부를 월세로 전환할 때 적용되는 연간 이율입니다. 주택임대차보호법 제7조의2에 따라 법정 상한은 min(한국은행 기준금리 + 2%p, 10%) 중 낮은 값입니다. 2026년 7월 한은 기준금리 2.50% 기준 상한 4.5%. 집주인이 이를 초과해 월세를 요구하면 초과분은 무효이며 반환 청구가 가능합니다.' },
